...
const sql_create3="CREATE TABLE IF NOT EXISTS imagenes (id INTEGER PRIMARY KEY AUTOINCREMENT, url varchar (500) NOT NULL, destacado VARCHAR (20) NOT NULL, producto_id INT, FOREIGN KEY (producto_id) REFERENCES productos (id));";
...
const sql_create4="CREATE TABLE IF NOT EXISTS clientes (id INTEGER PRIMARY KEY AUTOINCREMENT, email VARCHAR (160) NOT NULL, password VARCHAR (160) NOT NULL, preg_seg varchar (160) NOT NULL, resp_seg varchar (160) NOT NULL)";
...
const sql_create5 = "CREATE TABLE IF NOT EXISTS monedas (id INTEGER PRIMARY KEY AUTOINCREMENT, nomenclatura VARCHAR (6) NOT NULL, descripcion VARCHAR (160) NOT NULL)";
